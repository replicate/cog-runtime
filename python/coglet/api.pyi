...
from typing import Any, AsyncIterator, Generic, Iterator, List, Optional, Type, TypeVar, Union, overload
...
def Input(default: Any = ..., *, description: Optional[str] = ..., ge: Optional[Union[int, float]] = ..., le: Optional[Union[int, float]] = ..., min_length: Optional[int] = ..., max_length: Optional[int] = ..., regex: Optional[str] = ..., choices: Optional[List[Union[str, int]]] = ..., deprecated: Optional[bool] = ...) -> Any:
